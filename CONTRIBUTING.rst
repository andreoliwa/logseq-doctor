...
When `reporting a bug <https://github.com/andreoliwa/logseq-doctor/issues>`_ please include:
...
logseq-doctor could always use more documentation, whether as part of the
official logseq-doctor docs, in docstrings, or even on the web in blog posts,
articles, and such.
